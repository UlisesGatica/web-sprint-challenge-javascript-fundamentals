...
// due to chain of inheritance they get it from the parent but they can not give a new function they receive to the parent
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(animalNames){
    const lowercased = animalNames.map(function(item){
  ...
  */
  ...
  function USApop(zooAnimals){
    const allPop = zooAnimals.reduce(function(acc, current){
...
*/
function CuboidMaker(constructor) {
  this.length = constructor.length,
  this.width = constructor.width,
  this.height = constructor.height
}
